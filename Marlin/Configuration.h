...
#define STRING_CONFIG_H_AUTHOR "Markus A Müller" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro Board V4.2.7"
...
#if(CONFIGURATION_H_VERSION == 20008)  //Original Config war für MArlin 2.0.8 der hier verwendete Core ist aber 2.0.7.2
