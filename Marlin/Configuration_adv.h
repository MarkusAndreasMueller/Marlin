...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LCD_SET_PROGRESS_MANUALLY   //ToDo: Parameter Prüfen, Doku ist da dürftig  
 ...
 */
#define MINIMUM_STEPPER_POST_DIR_DELAY 20 //für TMC220x ToDo: Im Code prüfen ob aktiviert sein sollte, Default // (in Kommentar)
#define MINIMUM_STEPPER_PRE_DIR_DELAY 20 //für TMC220x ToDo: Im Code prüfen ob aktiviert sein sollte, Default // (in Kommentar)
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE 0 //für TMC220x ToDo: Im Code prüfen ob aktiviert sein sollte, Default // (in Kommentar)
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MAXIMUM_STEPPER_RATE 5000000 //für TMC220x ToDo: Im Code prüfen ob aktiviert sein sollte, Default // (in Kommentar)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      301  // (mm) The length of filament for a complete unload.
 ...
 */
   ...
   */
  //ToDo: Prüfen, war im ersten Versuch alles auskommentiert
